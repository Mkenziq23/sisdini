                ...
                <div class="container-fluid">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $deteksicount }}
                                            </div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Presisi
                                    </div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        {{ number_format($precision * 100, 2) }}%
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Akurasi
                                    </div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Recall</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        {{ number_format($recall * 100, 2) }}%
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-6 mb-4">
                            <div class="card shadow h-100">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Grafik Evaluasi Model (Bar)</h6>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-xl-4 col-lg-6 mb-4">
                            <div class="card shadow h-100">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Grafik Evaluasi Model (Doughnut)</h6>
                                </div>
                                <div class="card-body">
                    ...
                    <script>
                        ...
                        new Chart(barCtx, {
                            type: 'bar',
                            data: {
                                labels: ['Presisi', 'Akurasi', 'Recall'],
                                datasets: [{
                                    label: 'Persentase (%)',
                                    data: [{{ $precision * 100 }}, {{ $accuracy * 100 }}, {{ $recall * 100 }}],
                                    backgroundColor: ['rgba(78,115,223,0.7)', 'rgba(28,200,138,0.7)',
                                        'rgba(54,185,204,0.7)'
                                    ],
